...
const closeEditExperienceModal = (e) => {
    editExperienceModal.value = e
}
const openAddExperienceModal = () => {
    addExperienceModal.value = true
}
const closeAddExperienceModal = (e) => {
    addExperienceModal.value = e
}
...
<template>
    <div class="container pb-20 mt-16 sm:mt-20">
        ...
        <AddExperienceModal v-if="addExperienceModal" :addExperienceModal="addExperienceModal"
            @close-add-experience-modal="closeAddExperienceModal" />
        <!-- /Add Experience Modal -->
            ...
            <div class=" flex-col flex-1 md:basis-8/12 space-y-2  ">
                ...
                <div class="border flex flex-col space-y-2 bg-white rounded-lg">
                    <div class=" relative py-6 pl-6 pr-14">
                        <div
                            class="absolute hover:bg-gray-200 rounded-full p-2 cursor-pointer transition-all duration-300 active:bg-gray-300 group top-4 right-4 ">
                            <svg @click="openEditModal" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                data-supported-dps="24x24" fill="#666666" class="group-active:fill-black" width="24"
                ...
                <div class="border flex flex-col space-y-2 bg-white rounded-lg">
                    <div class="relative py-6 pl-6 space-y-4 ">
                        <div class="flex space-x-2 absolute top-4 right-4 group ">
                            <button @click="openAddExperienceModal()"
                        ...
                        <div v-for="experience in currentUser?.experiences" :key="experience?._id"
                            ...
                            <EditExperienceModal v-if="editExperienceModal" :editExperienceModal="editExperienceModal"
                                @close-editExperience-modal="closeEditExperienceModal" :experience="experience" />
                            ...
                            <div class="flex flex-col w-full">
                                <p class="font-semibold flex justify-between items-center relative">{{ experience?.title }}
                                    <button @click="openEditExperienceModal()"
