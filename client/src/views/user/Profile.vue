                ...
                <div class="border flex flex-col space-y-2 bg-white rounded-lg">
                    <div class="relative">
                        <img class="rounded-t-lg"
                            ...
                            alt="">
                        <img @click="setName"
                            class="rounded-full absolute left-5 md:left-5 md:top-20 w-24 md:w-40 border-4 border-white"
                            :src="`${BASE_URL}/uploads/${currentUser.profile_image}`" alt="">
                    </div>
                    <div class="flex relative justify-between pt-24 md:pt-14 pb-7 pl-6 pr-20 items-start">
                        <div
                        ...
                        <div class="flex justify-start items-start space-x-2">
                            ...
                            <div class="flex flex-col">
                                ...
                                <div class="flex justify-start items-start space-x-2">
                                  ...
                                  <p class="text-sm">
                                    Teknik Destek · Bilgisayar Donanımı · Bilgisayar Donanımı Sorun Giderme · Bilgisayar Tamiri · Bilgisayar Ağları · İnsan Bilgisayar Etkileşimi
                                  </p>
                                </div>
                            </div>
                        </div>
